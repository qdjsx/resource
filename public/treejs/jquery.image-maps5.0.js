...
//console.log("specialHotItemDom:"+specialHotItemDom);
					...
					if (rowTagDom == "tr") {
						...
						item.push('<td>链接或ID：<input type="text"  name="urls[]"  lay-verify="required"  class="layui-input" placeholder="请填写正确链接或ID" value="' + areaLink + '" /></td>');
						item.push('<td>位置(横纵坐标,横纵坐标)：<input type="text" name="coordinate[]" class="areaMapInfo layui-input"  lay-verify="required"  value="'+ areaMapInfo + '" /></td>');
						...
						// item.push(specialHotItemDom);
                        item.push('<td>链接或ID：<input type="text"  name="needs"  lay-verify="required"  class="layui-input" value="' + areaLink + '" /></td>');
